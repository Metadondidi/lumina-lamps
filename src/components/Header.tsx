...
export default function Header() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-[70] transition-all duration-500 ease-luxury ${
      ...
      <div
        className={`fixed inset-0 z-[60] bg-ivory transition-all duration-500 ease-luxury md:hidden ${
          isMobileMenuOpen 
        ...
        style={{ top: 0 }}
      >
        <div className="container-luxury pt-28 pb-10 h-full flex flex-col overflow-y-auto">
